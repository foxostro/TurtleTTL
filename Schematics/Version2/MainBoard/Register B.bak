...
AR Path="/5D2C0D13/5DD6C85F" Ref="C72"  Part="1" 
AR Path="/5DF275FA/5DD6C85F" Ref="C?"  Part="1" 
F 0 "C72" H 8015 5396 50  0000 L CNN
F 1 "100nF" H 8015 5305 50  0000 L CNN
F 2 "Capacitor_THT:C_Disc_D4.3mm_W1.9mm_P5.00mm" H 7938 5200 50  0001 C CNN
...
AR Path="/5D2C0D13/5DD6C865" Ref="C73"  Part="1" 
AR Path="/5DF275FA/5DD6C865" Ref="C?"  Part="1" 
F 0 "C73" H 8515 5396 50  0000 L CNN
F 1 "100nF" H 8515 5305 50  0000 L CNN
F 2 "Capacitor_THT:C_Disc_D4.3mm_W1.9mm_P5.00mm" H 8438 5200 50  0001 C CNN
...
AR Path="/5D2C0D13/5DD6C86B" Ref="#PWR0178"  Part="1" 
AR Path="/5DF275FA/5DD6C86B" Ref="#PWR?"  Part="1" 
F 0 "#PWR0178" H 7900 5250 50  0001 C CNN
...
AR Path="/5D2C0D13/5DD6C871" Ref="#PWR0177"  Part="1" 
AR Path="/5DF275FA/5DD6C871" Ref="#PWR?"  Part="1" 
F 0 "#PWR0177" H 7900 5050 50  0001 C CNN
...
AR Path="/5D2C0D13/5DD6C883" Ref="#PWR0175"  Part="1" 
AR Path="/5DF275FA/5DD6C883" Ref="#PWR?"  Part="1" 
F 0 "#PWR0175" H 6650 1750 50  0001 C CNN
...
AR Path="/5D2C0D13/5DD6C889" Ref="#PWR0176"  Part="1" 
AR Path="/5DF275FA/5DD6C889" Ref="#PWR?"  Part="1" 
F 0 "#PWR0176" H 6650 3250 50  0001 C CNN
...
AR Path="/5D2C0D13/5DD6C88F" Ref="#PWR0173"  Part="1" 
AR Path="/5DF275FA/5DD6C88F" Ref="#PWR?"  Part="1" 
F 0 "#PWR0173" H 4550 3250 50  0001 C CNN
...
AR Path="/5D2C0D13/5DD6C895" Ref="U68"  Part="1" 
AR Path="/5DF275FA/5DD6C895" Ref="U?"  Part="1" 
F 0 "U68" H 6400 3500 50  0000 C CNN
F 1 "74AHCT245" H 6400 3400 50  0000 C CNN
F 2 "Package_DIP:DIP-20_W7.62mm" H 6650 2700 50  0001 C CNN
F 3 "http://www.ti.com/lit/ds/symlink/sn54ahct245.pdf" H 6650 2700 50  0001 C CNN
	1    6650 2700
	1    0    0    -1  
$EndComp
$Comp
...
AR Path="/5D2C0D13/5DD6C89B" Ref="#PWR0172"  Part="1" 
AR Path="/5DF275FA/5DD6C89B" Ref="#PWR?"  Part="1" 
F 0 "#PWR0172" H 4550 1750 50  0001 C CNN
...
AR Path="/5D2C0D13/5DD6C8A1" Ref="U67"  Part="1" 
AR Path="/5DF275FA/5DD6C8A1" Ref="U?"  Part="1" 
F 0 "U67" H 4350 3500 50  0000 C CNN
F 1 "74F377" H 4300 3400 50  0000 C CNN
F 2 "Package_DIP:DIP-20_W7.62mm" H 4550 2700 50  0001 C CNN
...
U 1 1 5D91B962
P 4200 5600
AR Path="/5D2C12A5/5D91B962" Ref="#PWR?"  Part="1" 
AR Path="/5D2C0D13/5D91B962" Ref="#PWR0171"  Part="1" 
AR Path="/5DF275FA/5D91B962" Ref="#PWR?"  Part="1" 
F 0 "#PWR0171" H 4200 5350 50  0001 C CNN
...
U 1 1 5D91B96D
P 3800 6100
AR Path="/5D29E36D/5D91B96D" Ref="J?"  Part="1" 
AR Path="/5D2C12A5/5D91B96D" Ref="J?"  Part="1" 
AR Path="/5D2C0CE4/5D91B96D" Ref="J?"  Part="1" 
AR Path="/5D2C0D13/5D91B96D" Ref="J9"  Part="1" 
AR Path="/5DF275FA/5D91B96D" Ref="J?"  Part="1" 
F 0 "J9" V 3950 6050 50  0000 C CNN
F 1 "B Register LED Connector" V 4050 6050 50  0000 C CNN
F 2 "Connector_PinSocket_2.54mm:PinSocket_1x09_P2.54mm_Vertical" H 3800 6100 50  0001 C CNN
...
U 1 1 5D9A4FBB
P 6150 3100
AR Path="/5D2C0D13/5D9A4FBB" Ref="#PWR0199"  Part="1" 
AR Path="/5DF275FA/5D9A4FBB" Ref="#PWR?"  Part="1" 
F 0 "#PWR0199" H 6150 2950 50  0001 C CNN
F 1 "VCC" V 6168 3227 50  0000 L CNN
